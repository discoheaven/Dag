...
public:
    Greedy() = default;
    void run(const Dagger& dag, const System& sys, Scheduler& scheduler, int rank = 0); //do_not_use
private:
    void initialize(const Dagger &dag, const System &sys, Scheduler& scheduler);
